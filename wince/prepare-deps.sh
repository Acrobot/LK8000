...
# will be built once we reach the link milestone.
...
# sufficient for compile-level bring-up with mingw32ce. A real target build
# will replace this with the configuration generated by the WinCE toolchain.
